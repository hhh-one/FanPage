...
<div class="content">
	<div class="content-wrap">
		...
		<div class="CommentBox">
			...
			<form action="deleteComment.comment" method="post">
				<div class="comment-list">
					...
					<c:if test="${ comment.name == sessionScope.member_name }">
						<div class="comment-edit"><input type="hidden" value="수정" class="" onclick="location.href=''" /></div>
						<div class="comment-delete"><input type="submit" value="삭제" /></div>
					</c:if>
					</div>
				</div>
			</form>
		...
		<c:if test="${ boardvo.name == sessionScope.member_name }">
			...
			<input type="button" value="삭제" class="delete-btn" data-bno="${boardvo.bno}" onclick="confirmDelete(this)'" />
		</c:if>
